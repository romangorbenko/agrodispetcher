...
Время посевной и уборочной компании это всегда вызов для компании из агросектора. Например, как оптимально использовать имеющуюся в распоряжении компании технику? Что делать когда ресурсов не хватает и что делать, когда они простаивают?

Например, если компания АО "Урожай-1" преимущественно специализируется на выращивании сахарной свеклы, а компания АО "Урожай-2" преимущественно специализируется на выращивании картофеля то из-за разного времени сбора урожая пик использования техники будет приходиться у них на разные периоды времени.

Решить это поможет переход к сервис-ориентированную стратегия владения техникой. Во время высокого внутреннего спроса  привлекается техника других участников рынка, во время низкого предоставляется тем, кому она будет нужна.

Система "Агродиспетчер" как раз и призвана организовать такую сервис-ориентированную модель. 

Владелец техники (Owner) может загрузить и управлять профилями имеющихся в его распоряжении транспортных средств (Vehicle). Потенциальные клиенты (Customer) могут оставлять заявки на заказ транспорта (TransportRequest) или выбирать его из имеющегося поблизости (TransportSelect). Результатом успешной сделки одобренной владельцем и арендатором является заказ-наряд на подачу техники (TransportOrder).
